  ...
  return (
    <div className="relative max-w-7xl mx-auto mt-20 pb-20">
      <div className="flex flex-col justify-center items-center px-10 md:px-20">
        ...
        <p className="text-xs mt-1">Effective date: 28/07/2024</p>
        ...
        <div className="max-w-4xl mx-auto mt-8 text-gray-700 pb-16 border-2 border-black p-10 rounded-xl mb-10">
          <div>
            ...
            <p className="mt-2">
              Welcome to SimpliAnimate (“us”, “we”, or “our”) operates
              SimpliAnimate (website/mobile application) (hereinafter referred
              to as “Service”). Our Privacy Policy governs your visit to
              SimpliAnimate (website/mobile application), and explains how we
              ...
              Terms and Conditions govern all use of our Service and together
              with the Privacy Policy constitute your agreement with us
              (“Agreement”).
            </p>
            <p className="mt-4">2. Definitions</p>
            <p className="mt-2">
              ...
              we are a Data Controller of your data; <br />
              ...
              Personal Data; <br />
              “Location Data” shall have the meaning ascribed to it in Clause
              4.3; <br />
              “Personal Data” means data about a living individual who can be
              identified from those data (or from those and other information
              either in our possession or likely to come into our possession);{" "}
              <br />
              “Service” means the SimpliAnimate (website/mobile application).;{" "}
              <br />
              “Usage Data” means data collected automatically either generated
              by the use of Service or from Service infrastructure itself (for
              example, the duration of a page visit); and <br />
              “User(s)” means the person(s) using our Service and who
              corresponds to the Data Subject, which is the subject of Personal
              Data. <br />
            </p>
            <p className="mt-4">3. Information Collection and Use</p>
            <p className="mt-2">
              We collect several different types of information for various
              purposes to provide and improve our Service to you.
            </p>
            <p className="mt-4">4. Types of Data Collected</p>
            <p className="mt-2"></p>
            <p>a. Personal Data</p>
            <br />
            <p>
            ...
            the unsubscribe link or by emailing to simplianimate@gmail.com.{" "}
            <br />
            <br />
            <p>b. Usage Data</p> <br />
            <p>
            ...
            <p></p>
            <p className="mt-4">5. Use of Data</p>
            <p className="mt-2">
              SimpliAnimate uses the collected data for various purposes such
              as: <br />
            </p>
            ...
            <p></p>
            <p className="mt-4">6. Retention of Data</p>
            <p className="mt-2">
            ...
            <p className="mt-4">7. Transfer of Data</p>
            <p className="mt-2"></p>
            <ol className="list-decimal list-inside">
              <li>
              ...
              <li>
                SimpliAnimate will take all the steps reasonably necessary to
            ...
            <p className="mt-4">9. Changes to This Privacy Policy</p>
            <p className="mt-2">
            ...
            <p className="mt-2">
              ...
              contact us: simplianimate@gmail.com
            </p>
          </div>
        </div>
      </div>
