        ...
        <div className="max-w-3xl relative mx-auto mt-8 bg-white text-gray-800 pb-16 border-2 border-black p-10 rounded-xl mb-10">
          <div className="drop-shadow-none z-10 ">
            ...
            <p className="mt-2">
              ...
              to the popular TV show "Who Wants to Be a Millionaire," focusing
              on Kannada grammar and general knowledge. Instead of creating a
              template in Premiere Pro, I decided to build a web app, and that's
            ...
            <p className="mt-2">
              ...
              you're looking for that we don't have yet, please let us know.
              We're constantly adding new features and templates to make this
              better.
            </p>
